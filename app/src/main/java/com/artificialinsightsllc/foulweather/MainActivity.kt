// app/src/main/java/com/artificialinsightsllc/foulweather/MainActivity.kt
...
class MainActivity : ComponentActivity() {
     ...
     * This function manages the navigation graph and handles global app logic like permissions.
     *
     * @param newIntentFlow A [MutableStateFlow] that emits new [Intent] objects when the activity receives them.
     */
    @Composable
    private fun AppContent(newIntentFlow: MutableStateFlow<Intent?>) {
        FoulWeatherTheme {
            Surface(
                ...
                val context = LocalContext.current // Current Android context
